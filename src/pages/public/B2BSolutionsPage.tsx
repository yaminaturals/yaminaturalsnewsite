...
export const B2BSolutionsPage: React.FC = () => {
  return (
    <>
      <SEO
        title="B2B Natural & Herbal Product Solutions | Yami Naturals"
        description="High-volume, documented raw material supply for manufacturers, nutraceutical compounders, and cosmetic brands. Bulk volumes, technical dossiers, and export logistics."
        canonicalPath="/b2b-solutions"
        structuredData={generateBreadcrumbSchema([
          { name: 'Home', url: '/' },
          { name: 'B2B Solutions', url: '/b2b-solutions' },
        ])}
      />
      <PagePlaceholder
